                ...
                <div className="max-w-2xl mx-auto mb-12">
                    <div className="relative flex gap-2">
                        <Input
                            ...
                            className="pr-12 bg-surface/50 border-white/10 focus:border-cyan/50"
                        />
                        <Button
                            size="icon"
                            variant="ghost"
                            className="absolute right-1 top-1/2 -translate-y-1/2 h-7 w-7 text-cyan hover:bg-cyan/10"
                            disabled={isLoading}
                        >
